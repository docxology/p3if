...
try:
    from p3if.visualization.static.matrix import MatrixVisualizer
    from p3if.visualization.static.network import NetworkVisualizer
    from p3if.visualization.interactive.interactive import InteractiveVisualizer
