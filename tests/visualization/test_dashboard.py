...
from p3if.visualization.portals import (  # noqa: E402 - after sys.path setup
    DashboardGenerator,
)  # noqa: E402 - import after sys.path setup
from p3if.utils.config import Config  # noqa: E402 - import after sys.path setup
from tests.fixtures.helpers import (  # noqa: E402 - after sys.path setup
...
class TestDashboardGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_dir = type(
            "obj",
            (object,),
            {"name": str(self.output_path), "cleanup": lambda: None},  # No-op cleanup function
        )
    ...
    def test_generate_domain_dashboard(self):
        ...
        result = self.multi_domain_dashboard.generate_domain_dashboard(
            domain="Domain1", output_dir=output_dir
        )
    ...
    def test_generate_comparison_dashboard(self):
        ...
        result = self.multi_domain_dashboard.generate_comparative_dashboard(
            domains=["Domain1", "Domain2"], output_dir=output_dir
        )
            ...
            [
                {
                    "id": "pattern-type",
                    "name": "Pattern Type",
                    "options": ["Property", "Process", "Perspective"],
                },
                {
                    "id": "strength",
    ...
    def test_generate_full_dashboard_with_dataset_selector(self):
        ...
        self.dashboard.generate_full_dashboard(
            output_file=output_file, title="Full Dashboard with Dataset Selector", datasets=datasets
        )
    ...
    def test_dashboard_responsive_design(self):
        ...
        self.dashboard.generate_full_dashboard(
            output_file=output_file, title="Responsive Dashboard Test"
        )
