...
def framework_with_domains():
    ...
    framework.add_pattern(
        Property(name="Property 1", description="Test property from domain1", domain="domain1")
    )
    framework.add_pattern(
        Property(name="Property 2", description="Test property from domain2", domain="domain2")
    )
    framework.add_pattern(
        Property(name="Property 3", description="Test property from domain3", domain="domain3")
    )

    # Add processes from different domains
    framework.add_pattern(
        Process(name="Process 1", description="Test process from domain1", domain="domain1")
    )
    framework.add_pattern(
        Process(name="Process 2", description="Test process from domain2", domain="domain2")
    )
    ...
    framework.add_pattern(
        Perspective(
            name="Perspective 1",
            description="Technical perspective from domain1",
            domain="domain1",
            viewpoint="technical",
        )
    )
    framework.add_pattern(
        Perspective(
            name="Perspective 2",
            description="Business perspective from domain3",
            domain="domain3",
            viewpoint="business",
        )
    )
