...
class TestAllDomains(unittest.TestCase):
    ...
    def test_all_domains_can_generate_data(self):
        ...
        for domain_name in self.all_domains:
            ...
            self.assertGreater(len(framework._patterns), 0, f"No patterns generated for domain: {domain_name}")
            self.assertGreater(len(framework._relationships), 0, f"No relationships generated for domain: {domain_name}")
    ...
    def test_multiple_domains_can_be_visualized_together(self):
        ...
        self.assertGreater(len(framework._relationships), 0, "No relationships generated for multi-domain")
