...
from tests.fixtures.helpers import create_test_framework, create_multi_domain_test_framework
...
class TestVisualizationPortal(unittest.TestCase):
        ...
        components = [
            {
                "id": "3d-cube",
                "name": "3D Cube",
                "description": "3D visualization of P3IF relationships",
            },
            {
                "id": "network",
                "name": "Network Graph",
                "description": "Network visualization of P3IF elements",
            },
            {
                "id": "matrix",
                "name": "Matrix View",
                "description": "Matrix visualization of P3IF relationships",
            },
        ]
    ...
    def test_multi_domain_portal(self):
        ...
        # Generate the HTML file
        self.multi_domain_portal.generate_portal(
            output_file=output_file,
    ...
    def test_portal_css(self):
        ...
        # Generate the HTML file
        self.portal.generate_portal(output_file=output_file, title="Test CSS Portal")
    ...
    def test_portal_javascript(self):
        ...
        # Generate the HTML file
        self.portal.generate_portal(output_file=output_file, title="Test JS Portal")
